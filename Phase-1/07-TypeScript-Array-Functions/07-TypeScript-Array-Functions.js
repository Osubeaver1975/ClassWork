 ...
 *
 * .filter() uses an an arrow-func that takes the current element as a parameter
 ...
 *
 * .filter() will add the current element to the new array if the arrow-func returns true
 *
