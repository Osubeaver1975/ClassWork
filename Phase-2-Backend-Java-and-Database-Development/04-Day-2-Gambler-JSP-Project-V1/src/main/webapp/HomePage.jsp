...
<!--       method="delete" indicates doDelete() method in servlet should run         -->
	<form action="./gambler" method="get">
		Display Gambler with id: <input type="text" size=5 name="id" required>
	</form>
</div>
<div class="options">
	<form action="./gambler" method="get">
		Display Gambler with name: <input type="text" size=25 name="gamblerName" required>
	</form>
</div>
<div class="options">
	<form action="./gambler?action=delete" method="get">
		Delete Gambler with id: <input type="text" size=5 name="id2Delete" required>
	</form>
</div>
<div class="options">
	<form action="./gambler?action=update" method="post">
		Update Gambler with id: <input type="text" size=5 name="id2Update" required>
	</form>
</div>
</body>
</html>